...
if __name__ == '__main__':
    ...
    plt.plot(ell[alpha_2_neg], -alpha_2[alpha_2_neg], 'r--', label=r'$\alpha_2$',linewidth=1, color = 'm')  # Dashed red line for negative values
...
plt.legend()
plt.grid(True)
plt.savefig('Transformed_Cells_plot_combined.pdf')
plt.show()